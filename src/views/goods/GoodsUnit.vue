<template>
  <div class="cm-cont-inner">
    <div class="cm-top">
      <div class="cm-f-b-c">
        <div>
          <Button type="primary" ghost @click="openAdd">新增属性</Button>
        </div>
      </div>
    </div>
    ...
    <Modal
      ...
      @on-ok="ok"
      @on-cancel="cancel">
      <add-unit v-if="visible" ref="handlepage" @onClose="onClose" @setLoad="setLoad"></add-unit>
    </Modal>
  </div>
</template>
<script>
import CommonTips from '../common/CommonTips'
import AddUnit from '../../components/Goods/AddUnit'
export default {
  name: 'GoodsUnit',
  data () {
    return {
